...
<div class="card border-4 border-sponsor-platinum">
  <div class="card-body">
    ...
    <ul class="space-y-2 text-[var(--color-text-muted)]">
      ...
      <li>Large logo on team shirts</li>
      <li>Featured on website homepage</li>
      <li>Social media recognition</li>
      <li>Pit display banner</li>
      <li>VIP invitation to competitions</li>
    </ul>
  </div>
</div>
...
Donations to our team may be tax-deductible. Please contact us for more information.
